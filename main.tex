...
\label{chap:rel-work}
% Introduction
While Chapter \ref{chap:background} served the purpose of giving some background on the technical side, now related work shall be presented. This chapter presents a selection of psychological and sociological research done in context of (synthetic) media trust and credibility and the effects of fake news in general. 

\subsubsection*{Historical and geographical Context}
As stated in the Introduction, synthetic media is a rather new trend, mainly driven by the advance of \gls{genai}. It can be dated back to earliest of 2017 when DeepFake FaceSwaps surfaced to the broader public. It is remarkable, that \textit{Fake News} are also a very young topic on their own that developed around the same time as DeepFake FaceSwaps around 2016. For completeness it should be noted that the \citet{merriam-websterdictionaryRealStoryFake} dates the first use of Fake news back to the year 1890. Surely skepticism has always existed towards politics and media, but it surely wasn't as a big of a topic until Donald Trump entered his presidential campaign in 2016. That said, this paper will focus on works after 2016/2017. 
...
In our study we investigate a german-speaking population. There papers, that are focussed on a certain terretory (mostly US in relation of Trump) can only be included with the caviat that they might not directly apply to this cultural space as well. To illustrate the difference we can refer to figure \ref{fig:media-trust-comparison}. While trust among american public decreased around 2016, no impact can be seen in Germany at this time. It took until the years of the Covid19 Pandemic to experience a decline in Germany as well. It remains to be seen how this trend will continue in the following years.
\begin{figure}[h]
  \centering
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{./graphics/images/trust-america mainstream.png}
  ...
  \begin{subfigure}{\textwidth}
    ...
    \label{fig:trust-ger}
  \end{subfigure}
  \caption{Comparison of Media Trust US and Germany}
  \label{fig:media-trust-comparison}
\end{figure}
...
\subsubsection*{Effects measured on secondary media}
% Reviews without studies on metadata such as newspaper or sentiment analysis: Hard to find studies bla bla 
While few studies have been conducted, some other authors that some authors approached the topic via reviewing current technologies. In 2020 \citet{tolosanaDeepfakesSurveyFace2020} list face synthesis, facial attribute manipulation, idenity swap and expression swap.\\
\citet{westerlundEmergenceDeepfakeTechnology2019a} chose news articles to reflect on benefits, threats and examples of current DeepFakes and how to combat them. The authors list several benefits in the regions of media production,educational media and digitalcommunications, games and entertainment, socialmedia and healthcare, material science, and various business fields, such as fashion and ecommerce. \Citeauthor{westerlundEmergenceDeepfakeTechnology2019a} also conclude: "According to our study, deepfakes are a major threat to society, the political system and businesses[...]". About a possible solution four fields are named: "1) legislation and regulation, 2) corporate policies and voluntary action,3) education and training, and 4) anti-deepfake technology". Section \ref{sec:rel-work-counteringdf}\\

\todo{analysis of Youtube Videos} Lee et al
\todo{analysis of Reddit mining} Brooks

% Reviews with studies on actual people
\subsubsection*{Effects within study participants}
...
The literature review reveals, that concrete studies about the societal effects of synthetic media are often missing. This is understandable due to the novelty of the technologies, their complexity and the availability of tools for creation. In order to conduct research one first has be be able to create such material that is comparable to material "in the wild". This is even more true in the advent of \gls{genai} as more more content is getting produced and consumed.
