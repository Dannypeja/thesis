...
\subsubsection{RQ1 Low artificiality leads to more trust}
...
\begin{table}[h]
	...
	\label{tab:trust-RI1-correlations}
	{
		\begin{tabular}{lrrrrr}
			...
			4\_1\_RI & Pearson's r & $-8.671\times10^{-4}$ & $0.081$ & \textbf{0.312} & $0.263$   \\
...
We don't think this poses convincing evidence, as all other cases are insignificant but together with the verbal discussion we have hints that this topic could be researched further, especially with mobile devices getting more and more important.
