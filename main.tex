...
It lies in the nature of the question that resulting data is heavily skewed in many cases (figures \ref{fig:RI11}, \ref{fig:RI12}, \ref{fig:RI31}, \ref{fig:RI32}, \ref{fig:RI11}, \ref{fig:RI41}, \ref{fig:RI42}). This clearly prohibits the assumption of normality. However the central limit theorem for larger sample sizes (n > 30) considers normality to be less critical. With our sample size being 195 we will continue with using parametric tests. In addition we combined all RIs from group for videos *_1 and *_2. As seen in figures \ref{fig:grouped-RI1} and \ref{fig:grouped-RI2} they seem to be normally distributed. Shapiro
