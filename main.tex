...
\textbf{Keywords:} Synthetic Media, Trustworthiness, Generative AI, Media Authenticity, Disclosure of AI Usage
...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{l|X}
    ...
    \midrule
    RQ1a & Will video artificiality have an impact on trustworthiness?  \\
    \midrule
