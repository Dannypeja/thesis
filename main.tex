...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{./graphics/images/w2l-arch.png}
...
Ideally one would work with higher resolution \gls{w2l} or newer approaches like those from \citet{guptaGeneratingUltraHighResolution2023}. Unfortunately those didn't offer an \gls{oss} implementation at the time and therefore couldn't be tested.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{./graphics/images/wav2lip-demo.png}
...
\label{sec:v2v}
Besides the image generation models, civitai.com also started featuring voice models which will be further described in later sections. \\
